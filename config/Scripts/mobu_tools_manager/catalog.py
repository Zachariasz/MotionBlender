...
FEATURES = [
    ...
    FeatureSpec(
        ...
        "Objects/Scene",
        "command",
        ("custom/FindSelectedInHierarchy.py",),
        "mobu_tools_manager/features/find_in_hierarchy.py",
        entrypoint="execute",
        ...
        autorun_on_load=False,
        module="mobu_tools_manager.features.find_in_hierarchy",
        implementation_files=(
            "mobu_tools_manager/features/find_in_hierarchy.py",
        ),
    ),
    ...
    FeatureSpec(
        ...
        "Selection",
        "service",
        ("custom/DeselectAll.py",),
        "mobu_tools_manager/features/deselect_all.py",
        entrypoint="start",
        stop_entrypoint="stop",
        action_slot=54,
        default_shortcut="{NONE:A*DN}",
        warmup="startup",
        run_resource_method="execute",
        context_requirements=(
            "ui",
            "input",
            "selection",
        ...
        autorun_on_load=True,
        resident=True,
        module="mobu_tools_manager.features.deselect_all",
        implementation_files=(
            "mobu_tools_manager/features/deselect_all.py",
            "custom/DeselectAll.py",
        ),
    ...
    FeatureSpec(
        ...
        "Toggle Global/Local Reference",
        "Input/UI",
        "service",
        (),
        "mobu_tools_manager/features/reference_mode.py",
        entrypoint="start",
        stop_entrypoint="stop",
        default_shortcut="X",
        warmup="startup",
        ...
        autorun_on_load=False,
        resident=True,
        module="mobu_tools_manager.features.reference_mode",
        implementation_files=(
            "mobu_tools_manager/features/reference_mode.py",
        ),
    ),
    FeatureSpec(
        ...
        "service",
        (),
        "mobu_tools_manager/features/viewer_display_menu.py",
        entrypoint="start",
        stop_entrypoint="stop",
        ...
        autorun_on_load=False,
        resident=True,
        module="mobu_tools_manager.features.viewer_display_menu",
        implementation_files=(
            "mobu_tools_manager/features/viewer_display_menu.py",
    ...
    FeatureSpec(
        ...
        "Playback Frame Mode Menu",
        "Input/UI",
        "service",
        (),
        "mobu_tools_manager/features/playback_frame_mode.py",
        entrypoint="start",
        stop_entrypoint="stop",
        default_shortcut="`",
        warmup="startup",
        ...
        autorun_on_load=False,
        resident=True,
        module="mobu_tools_manager.features.playback_frame_mode",
        implementation_files=(
            "mobu_tools_manager/features/playback_frame_mode.py",
            "mobu_tools_manager/runtime.py",
        ),
    ...
    FeatureSpec(
        ...
        "Timeline: Go to Previous Take",
        "Animation/Story",
        "command",
        ("Tasks/GoToPreviousTake.py",),
        "mobu_tools_manager/features/timeline_navigation.py",
        entrypoint="go_to_previous_take",
        action_slot=8,
        default_shortcut="",
        warmup="idle",
        context_requirements=("take",),
    ...
    FeatureSpec(
        ...
        "Timeline: Add Local Marker",
        "Animation/Story",
        "command",
        (),
        "mobu_tools_manager/features/timeline_navigation.py",
        entrypoint="add_local_marker",
        action_slot=53,
        default_shortcut="{CTRL:M*DN}",
        warmup="idle",
    ...
    FeatureSpec(
        ...
        resident=True,
        run_resource_method="execute",
        context_requirements=("take", "undo", "evaluation", "ui"),
    ...
    FeatureSpec(
        ...
        "mobu_tools_manager/features/antigravity_bridge.py",
        entrypoint="start",
        stop_entrypoint="stop",
        default_enabled=True,
        warmup="never",
        resident=True,
        resource_attrs=("_antigravity_bridge_service",),
        context_requirements=("ui",),
        module="mobu_tools_manager.features.antigravity_bridge",
        implementation_files=(
            "mobu_tools_manager/features/antigravity_bridge.py",
            "mobu_tools_manager/runtime.py",
        ),
